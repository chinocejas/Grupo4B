 ...
 * @author John
 */
public class CopiarPuesto extends javax.swing.JFrame {
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        if("".equals(codigo2) && "".equals(puesto2) && "".equals(empresa2)){ //no completo al menos un criterio de busqueda
            ...
            gestorPuesto.buscarPuestosTemporal(modeloTabla);  //busca en la BS y completa la tabla que es pasada por parametro con los resultados
            
        }
        else{
        GestorPuesto gestorPuesto = GestorPuesto.getInstance();     //se pide la instancia de GestorPuesto

        gestorPuesto.buscarPuestosTemporal(modeloTabla, codigo2, puesto2, empresa2);  //busca en la BS y completa la tabla que es pasada por parametro con los resultados
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CopiarPuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CopiarPuesto().setVisible(true);
            }
        });
    }
